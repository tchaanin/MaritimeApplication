        ...
        return (
            ...
            <div className="background">
                ...
                >
                    ...
                    {/*2. Row*/}
                    {/*centerbox7*/}
                    <div className={this.props.isDarkMode ? "centerbox7 grid-container-night container" : "centerbox7 grid-container"} key="k" data-grid={{ x: 1, y: 1, w: 2, h: 4 }}> <div style={{ float: "left" }}>SWT {this.state.speedThroughWaterValue}</div>
                    ...
                    {/*Compass Rose*/}
                    {/*centerbox2*/}
                    <div className={this.props.isDarkMode ? "centerbox2 grid-container-night container" : "centerbox2 grid-container"} key="m" data-grid={{ x: 5, y: 7, w: 2, h: 3 }}> <div style={{ float: "left" }}>SOG {this.state.speedOverGroundValue} </div>
                        <div style={{ float: "right" }} >
                            <div onClick={() => {
                                this.setState({
                                    isVisible: true,
                    ...
                    {/*centerbox3*/}
                    <div className={this.props.isDarkMode ? "centerbox3 grid-container-night container" : "centerbox3 grid-container"} key="n" data-grid={{ x: 4, y: 10, w: 2, h: 3 }}> <div style={{ float: "left" }}>AWS {this.state.angleTrueWaterKey}</div>
                        <div style={{ float: "right" }} >
                            <div onClick={() => {
                                this.setState({
                                    isVisible: true,
                    ...
                    <div className={this.props.isDarkMode ? "centerbox4 grid-container-night container" : "centerbox4 grid-container"} key="o" data-grid={{ x: 6, y: 10, w: 2, h: 3 }}> <div style={{ float: "left" }}>TWS {this.state.courseOverGroundTrueValue}</div>
                        <div style={{ float: "right" }} >
                            <div onClick={() => {
                                this.setState({
                                    isVisible: true,
                    ...
                    {/*centerbox1*/}
                    <div className={this.props.isDarkMode ? "centerbox1 grid-container-night container" : "centerbox1 grid-container"} key="p" data-grid={{ x: 5, y: 13, w: 2, h: 3 }}> <div style={{ float: "left" }}>STW {this.state.speedThroughWaterValue}</div>
                        <div style={{ float: "right" }} >
                            <div onClick={() => {
                                this.setState({
                                    isVisible: true,
